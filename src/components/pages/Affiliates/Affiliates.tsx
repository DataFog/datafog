...
export function Affiliates() {
  ...
  const totalEarn = pricingPlans?.[0]?.monthlyPrice
    ? (pricingPlans[0].monthlyPrice * hobbyValue +
       pricingPlans[1].monthlyPrice * growthValue) *
        0.3
    : 0;
        ...
        <Container maxW="container.lg" flexDirection="column">
          <Center flexDirection="column">
            ...
            <VStack gap="24px" mt="24px">
              ...
              >
                <Text w="220px">
                  Personal plan (${pricingPlans?.[0]?.monthlyPrice ?? 0}/month)
                </Text>
                <Slider
              ...
              >
                <Text w="220px">
                  Professional plan (${pricingPlans?.[1]?.monthlyPrice ?? 0}/month)
                </Text>
                <Slider
                  aria-label="slider-personal"
            ...
            <Text maxW="680px" textAlign="center">
              ...
              about.
              <br />
              No &ldquo;gotchas&rdquo; here, just some terms to keep everyone happy.
            </Text>
            <Flex maxW="680px">
              <UnorderedList
